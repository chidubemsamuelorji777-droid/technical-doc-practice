...
- **Suricata**: This is both an IDS and IPS tool. It is very popular for easy usage and versatility.  
   It is able to:
...
- **Splunk Cloud**: is a cost-effective SIEM tool. It is a cloud-based version of Splunk Enterprise. The infrastrusture management is handled by Splunk. On it you can:
  - Upload log data.
  - Search through indexed data.
  - Evaluate search results.
  - Identify different data sources.
  - Locate failed SSH logins.
- **Google Security Operations**: Also known as Google SecOps. It is a Google cloud-hosted SIEM tool designed to speedily analyze and remedy threats. On it you can:
